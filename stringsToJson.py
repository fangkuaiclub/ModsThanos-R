...
IN_FILE = os.path.join(WORKING_DIR, "StringsTranslation.xlsx")
OUT_FILE = os.path.join(WORKING_DIR, "ModsThanos", "Resources", "stringData.json")
...
if __name__ == "__main__":
  in_files = [
    os.path.join(WORKING_DIR, "StringsTranslation.xlsx"),
